export default function SocialButton({
  ...
  return (
    <div className="flex justify-center">
      <a
        href={link}
        className="group relative inline-flex w-80 items-center justify-center overflow-hidden rounded-xl border-4 border-[var(--button-color)] p-4 px-5 py-2.5 font-medium text-[#C4DFE6] shadow-md transition duration-300 ease-out"
      >
